  ...
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.rectangle359}>
        <h2 style={{ paddingTop: '150px', color: 'white', paddingLeft: '50px' }}>Files List</h2>
        <div style={{ paddingTop: '150px', paddingLeft: '50px' }}> {/* Adjust the padding value as needed */}
      ...
      <div className={classes.bottomSection}>
        ...
        <div className={classes.paper1}>{fileName}</div>
      </div>
    </div>
  );
});
